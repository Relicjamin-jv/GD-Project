...
public class rangeBasicEnemyFSM : FSM
{
    ...
    protected void UpdateAttackState()
    {
        ...
        else
        {
            ...
            {
                timerAttack = 5f;
                GameObject shot = Instantiate(rangedWeapon, new Vector2(this.transform.position.x, this.transform.position.y), Quaternion.identity);
            }
        }
